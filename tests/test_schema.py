...
class TestSchema(unittest.TestCase):  # pylint: disable=missing-class-docstring
    ...
    def test_RegularExpression(self):
        ...
        re_schema_2 = SCHEMA.RegularExpression(
            pattern="abc$", modifiers=0, re_object=None, re_name="my_re"
        )
        ...
        re_schema_optional = SCHEMA.RegularExpression(
            pattern="abc", modifiers=0, re_object=compiled_re, re_name="my_re"
        )
        ...
        re_schema_optional = SCHEMA.RegularExpression(
            pattern=None, modifiers=0, re_object=compiled_re, re_name=None
        )
        ...
        self.assertRaises(
            securesystemslib.exceptions.FormatError, SCHEMA.RegularExpression, 8
        )
