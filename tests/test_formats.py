...
class TestFormats(unittest.TestCase):  # pylint: disable=missing-class-docstring
    ...
    def test_schemas(self):
        ...
        valid_schemas = {
            ...
            "HASH_SCHEMA": (
                securesystemslib.formats.HASH_SCHEMA,
                "A4582BCF323BCEF",
            ),
            "HASHDICT_SCHEMA": (
            ...
            "HEX_SCHEMA": (
                securesystemslib.formats.HEX_SCHEMA,
                "A4582BCF323BCEF",
            ),
            "KEYID_SCHEMA": (
            ...
            "SCHEME_SCHEMA": (
                securesystemslib.formats.SCHEME_SCHEMA,
                "ecdsa-sha2-nistp256",
            ),
            "PATH_SCHEMA": (
            ...
            "PATHS_SCHEMA": (
                securesystemslib.formats.PATHS_SCHEMA,
                ["/home/McFly/", "/home/Tannen/"],
            ),
            "URL_SCHEMA": (
                securesystemslib.formats.URL_SCHEMA,
            ...
            "RSAKEYBITS_SCHEMA": (
                securesystemslib.formats.RSAKEYBITS_SCHEMA,
                4096,
            ),
            "PASSWORD_SCHEMA": (
                securesystemslib.formats.PASSWORD_SCHEMA,
                "secret",
            ),
            "PASSWORDS_SCHEMA": (
                securesystemslib.formats.PASSWORDS_SCHEMA,
                ["pass1", "pass2"],
            ),
            "KEYVAL_SCHEMA": (
                securesystemslib.formats.KEYVAL_SCHEMA,
                {"public": "pubkey", "private": "privkey"},
            ),
            "PUBLIC_KEYVAL_SCHEMA": (
            ...
            "SIGNATURE_SCHEMA": (
                ...
                {"keyid": "123abc", "method": "evp", "sig": "A4582BCF323BCEF"},
            ),
            "SIGNABLE_SCHEMA": (
                securesystemslib.formats.SIGNABLE_SCHEMA,
                {
                    "signed": "signer",
                    "signatures": [
                        {
            ...
            "ANY_KEYDICT_SCHEMA": (
                securesystemslib.formats.ANY_KEYDICT_SCHEMA,
                {
                    "123abc": {
                        "keytype": "rsa",
                        "scheme": "rsassa-pss-sha256",
        ...
        for schema_name, (
            schema_type,
            valid_schema,
        ) in valid_schemas.items():  # pylint: disable=unused-variable
    ...
    def test_format_base64(self):
        ...
        self.assertEqual(
            "dXBkYXRlZnJhbWV3b3Jr", securesystemslib.formats.format_base64(data)
        )
        self.assertTrue(
            isinstance(securesystemslib.formats.format_base64(data), str)
        )

        # Test conditions for invalid arguments.
        self.assertRaises(
            securesystemslib.exceptions.FormatError,
            securesystemslib.formats.format_base64,
            123,
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError,
    ...
    def test_parse_base64(self):
        ...
        self.assertEqual(
            b"updateframework", securesystemslib.formats.parse_base64(base64)
        )
        self.assertTrue(
            isinstance(securesystemslib.formats.parse_base64(base64), bytes)
        )
