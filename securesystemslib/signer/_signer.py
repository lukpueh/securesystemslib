...
class CryptoSigner(Signer, metaclass=ABCMeta):
    ...
    def _from_pem(
        ...
        """Factory to create CryptoSigner from private PEM."""

        # TODO: Should public_key be optional, to create it from PEM? Then, I'd
        #       need to support optional keyid and scheme Mutual, exclusive args
        #       suck. Maybe there can be a separate method.
        #
        #       Is there a nicer way to implement this without switch in
        #       CryptoSigner, but as separate methods in subclasses?
